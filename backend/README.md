...
## Project Structure
    ...
    ├── testappgeneration_d_44739  # Django project configurations
...
1. Clone this repo and `cd testappgeneration_d_44739`
...
2. Clone this repo and `cd testappgeneration_d_44739`
